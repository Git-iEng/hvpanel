...
def request_demo_view(request):
    ...
    subject = "New Enquirey for HV Panel Design"
    text_body = (
        "A newHV Panel Design request was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">New Enquiry for HV Panel Design</h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New contact submission for HV Panel Design"
        text_body = "\n".join(
            [
                "New contact submission for HV Panel Design:",
...
def contact_block_submit(request):
    ...
    # --- Email notification ---
    subject = f"[HV Panel Design] Consulting request: {name}"
 
    text_body = "\n".join([
        "A new consulting request was submitted for HV Panel Design:",
        f"Name: {name}",
        f"Email: {email}",
